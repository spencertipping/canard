...
return stack.h.interpret(stack.t,bindings) } } ) ,stash_bindings() ,permutation_bindings() ,numeric_bindings() ,arithmetic_bindings() ) } ,stash_bindings=function() {;
...
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( [ ( '^' + (x) + '' ) , {interpret: (function(x) {return(function(stack,bindings) {return stash_helper(x,stack.h,stack.t,bindings) } ) } ) (x) } ] ) ) ;
return xr} ) .call(this, (function(i,u,s) {if( (u-i) *s<0|| !s)return[] ;
for(var r= [] ,d=u-i;
d>0?i<=u
:i>=u;
i+=s)r.push(i) ;
return r} ) ( (1) , (4) , (1) ) ) ) ) } ,permutation_bindings=function() {;
return(function(o) {for(var r= {} ,i=0,l=o.length,x;
i<l;
 ++i)x=o[i] ,r[x[0] ] =x[1] ;
return r} ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( ( [ ( '%' + (x) + '' ) , {interpret: (function(x) {return(function(stack) {return append_items_to(up(stack, +x.charAt(0) ) ,stack,permutation_list(x.substr(1) ) ) } ) } ) (x) } ] ) ) ;
return xr} ) .call(this,permutation_names() ) ) ) } ,a2d= ( (function(xs1) {var x1,x01,xi1,xl1,xr1;
for(var xr1=new xs1.constructor() ,xi1=0,xl1=xs1.length;
xi1<xl1;
 ++xi1)x1=xs1[xi1] ,xr1.push( (String.fromCharCode(x1) ) ) ;
return xr1} ) .call(this, (function(i,u,s) {if( (u-i) *s<=0)return[] ;
for(var r= [] ,d=u-i;
d>0?i<u
:i>u;
i+=s)r.push(i) ;
return r} ) ( (97) , (101) , (1) ) ) ) .concat( ( [ '' ] ) ) ,permutation_names=function() {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push.apply(xr,Array.prototype.slice.call( ( (function(as) {var a,a0,ai,al,ar;
for(var ar=new as.constructor() ,ai=0,al=as.length;
ai<al;
 ++ai)a=as[ai] ,ar.push.apply(ar,Array.prototype.slice.call( ( (function(bs) {var b,b0,bi,bl,br;
for(var br=new bs.constructor() ,bi=0,bl=bs.length;
bi<bl;
 ++bi)b=bs[bi] ,br.push.apply(br,Array.prototype.slice.call( ( (function(cs) {var c,c0,ci,cl,cr;
for(var cr=new cs.constructor() ,ci=0,cl=cs.length;
ci<cl;
 ++ci)c=cs[ci] ,cr.push.apply(cr,Array.prototype.slice.call( ( (function(ds) {var d,d0,di,dl,dr;
for(var dr=new ds.constructor() ,di=0,dl=ds.length;
di<dl;
 ++di)d=ds[di] ,dr.push( ( ( '' + (x) + '' + (a) + '' + (b) + '' + (c) + '' + (d) + '' ) ) ) ;
return dr} ) .call(this,a2d) ) ) ) ;
return cr} ) .call(this,a2d) ) ) ) ;
return br} ) .call(this,a2d) ) ) ) ;
return ar} ) .call(this,a2d) ) ) ) ;
return xr} ) .call(this, (function(i,u,s) {if( (u-i) *s<0|| !s)return[] ;
for(var r= [] ,d=u-i;
d>0?i<=u
:i>=u;
i+=s)r.push(i) ;
return r} ) ( (0) , (4) , (1) ) ) } ,permutation_list=function(name) {;
return name.length?$.canard.syntax.cons(permutation_list(name.substr(0,name.length-1) ) ,$.canard.syntax.atom(name.charCodeAt(name.length-1) -97) ) 
:$.canard.syntax.nil() } ,numeric_bindings=function() {;
return(function(o) {for(var r= {} ,i=0,l=o.length,x;
i<l;
 ++i)x=o[i] ,r[x[0] ] =x[1] ;
return r} ) .call(this, ( (function(xs) {var x,x0,xi,xl,xr;
