...
bind cons.
    ...
    @!180 4831 o300 b8 51010400 48ab      # push pointer to cons function
    @!18a b8 @!18b 0200 ':: @!18f
    @!18f 48c7 o300 8b014000 48ab         # push symbol ::

    @!198 e8 6dffffff                     # invoke @:k to generate the closure
...
Let's go ahead and cons that onto the symbol table:
    ...
    @!1d4 4831 o300 b8 cd014000 48ab      # push pointer to symbol @:k
    ...
    @!1e9 b8 @!1ea e6014000 48ab          # push pointer to symbol ::
