...
In list form, this corresponds to a nil as the final tail.
    ...
    @!b5 488b o306 48ab @!ba        # push the c3 reference onto the data stack
...
on the data stack, ready to be consed into the symbol table.
    ...
    @!ba 48c7 o300 d1 00 40 00 48ab @!c3  # data-push code reference
    @!c3 48b8 @!c5 0300 '@:k  /3/00 @!cd  # literal symbol @:k
    @!cd 48c7 o300 c0 00 40 00 48ab @!d6  # data-push symbol reference
...
point is not yet functional.
    ...
    @!d6 eb2f @!d8                        # jump over constant_matcher
...
once we've defined cons and bind below.
    ...
    @!d8  488b o157 f8                    # -8(%rdi) -> %rbp
    @!dc  488b o107 f0                    # -16(%rdi) -> %rax
    @!e0  488b o137 e8                    # -24(%rdi) -> %rbx
    @!e4  4883 o357 10                    # %rdi -= 16 (pop two entries)

    @!e8  4831 o311 668b o010             # %rcx = length
    @!ee  6639 o013 e101 c3               # length check + bailout

    @!f4  8a o124 o013 02                 # top of loop: populate %dl
    @!f8  38 o124 o010 02                 # compare characters
    @!fc  74 01 c3                        # bail if not equal
    @!ff  e2 f3 @!101                     # next character

    @!101 4889 o157 f8                    # %rbp -> -8(%rdi)
    @!105 58 c3                           # return continuation
    @!107

Now we have the constant matcher function defined at address 0x4000d8, so we
...
the continuation immediately following its definition.
    ...
    @!10c 488b o107 f8                    # symbol pointer
    @!110 488b o137 f0                    # binding
    @!114 4883 o357 08                    # pop one (we replace the other later)

    @!118 488b o316                               # %rsi -> %rcx
    @!11b 4883 o356 1d                            # %rsi -= 29
    @!11f 66c7 o006 48b8      4889 o106 02        # 48b8, symbol pointer
    @!128 c7 o106 0a 48b848ab 4889 o136 0e        # 48b8, 48ab, binding
    @!133 c7 o106 16 48abe900                     # 48ab, e9
    @!13a 48c7 o300 d3004000                      # $constant_matcher -> %rax
    @!141 482b o301 4889 o106 19                  # 25(%rsi) = %rax - %rcx
    @!148 4889 o167 f8                            # %rsi -> -8(%rdi)
    @!14c c3
...
code.
    ...
    @!152 488b o107 f8            # head element
    @!156 488b o137 f0            # tail element
    @!15a 4883 o357 08            # pop one (the other will be overwritten)

    @!15e 4839 o336 740f                  # tail allocation check
    @!163 482b o336 6689 o136 fc          # relative, write e9 jump offset
    @!16a 4883 o356 05 48c6 o106 e9       # allocate space, write e9 jump opcode

    @!172 482b o306 6689 o106 fc          # relative, write e8 call offset
    @!179 488c o356 05 48c6 o106 e8       # allocate space, write e8 call opcode

    @!181 4889 o167 f8 c3                 # return new cons cell
    @!186
...
bind cons.
    ...
    @!186 4831 o300 66b8 52010400 48ab    # push pointer to cons function
    @!191 48b8 @!193 0200 ':: /4/00 @!19b
    @!19b 48c7 o300 93014000 48ab         # push symbol ::
